...
console.info(`[server] starting host=${config.host} port=${config.port} env=${config.nodeEnv} public_ws_url=${config.publicWsUrl || "(unset)"} cors_origin=${config.corsOrigin || "(none)"}`);
